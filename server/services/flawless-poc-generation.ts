  ...
  static async generatePOC(data: FlawlessPOCData): Promise<Buffer> {
    try {
      ...
      const doc = new PDFDocument({
        ...
        info: {
          Title: `${data.JOB_NUMBER} (POC)`,
          Author: "OVM Ltd",
          Subject: "Proof of Collection - Flawless Layout",
        },
      });
      ...
      // Title: "Proof of Collection" - perfectly centered in BLACK text
      doc
        .fontSize(24)
        .font("Helvetica-Bold")
        .fillColor(C.text)
        .text("PROOF OF COLLECTION", 0, y, {
